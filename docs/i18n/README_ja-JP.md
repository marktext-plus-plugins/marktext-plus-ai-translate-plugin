...
三つのうちどれかを書き忘れたテンプレートには、それが捨てられずに末尾へ付け足されます。扱うべきものが欠けたプロンプトは、整っていないプロンプトより悪いからです——モデルはどちらでも答えるので、見た目には何も問題がないまま、誰も尋ねていない問いに答えることになります。どの欄も既定値を示すので、何を変えているのかが見えます。空にすれば既定に戻ります。
